        ...
        {selectedItem && (
          ...
          >
            ...
            >
              ...
              {/* Modal Content */}
              <div className="p-6">
                <div className="aspect-video bg-gradient-to-br from-gray-300 to-gray-400 rounded-xl mb-6 flex items-center justify-center">
                  {selectedItem.type === 'video' ? (
                    <div className="text-center">
                      <div className="w-20 h-20 rounded-full bg-gradient-to-r from-red-600 to-orange-500 flex items-center justify-center mx-auto mb-4">
                        <Video className="h-10 w-10 text-white" />
                      </div>
                      <p className="text-gray-700">Video content would play here</p>
                    </div>
                  ) : (
                    <div className="text-center">
                      <ImageIcon className="h-20 w-20 text-gray-400 mx-auto mb-4" />
                      <p className="text-gray-700">Full-size image would display here</p>
                    </div>
                  )}
                </div>
